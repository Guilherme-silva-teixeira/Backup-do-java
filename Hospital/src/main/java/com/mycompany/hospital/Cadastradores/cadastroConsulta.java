...
public class cadastroConsulta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setForeground(new java.awt.Color(202, 251, 232));
        ...
        jLabel7.setFont(new java.awt.Font("Poppins Light", 0, 27)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(0, 0, 0));
        jLabel7.setText("Cadastrar nova consulta:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        medico = jTextField2.getText();
        data = jTextField3.getText();
        hora = jTextField4.getText();
        situacao = jTextField5.getText();
        descricao = jTextArea1.getText();
        if(paciente.isEmpty()||medico.isEmpty()||data.isEmpty()||hora.isEmpty()||situacao.isEmpty()||descricao.isEmpty())
        {
        ...
        }else
        {
            try
            {
                Consulta novaConsulta = new Consulta(paciente, medico, data, hora, situacao, descricao);
                Hospital.Consultas.add(novaConsulta);
